<template>
  <div class="flex w-screen h-screen">
          ...
          >
            <div class="flex flex-col items-center">
              ...
              <div
                ...
                class="w-0.5 h-12 bg-gray-400 my-2"
              />
            </div>
            <div class="pt-1">
    ...
    <div
      class="w-1/2 flex flex-col items-center justify-center p-8 lg:p-24 overflow-y-auto register-right-panel"
    >
      <!-- Success State -->
      <div
        v-if="showSuccess"
        class="fixed inset-0 w-full h-full bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 flex flex-col items-center justify-center p-8"
      >
        <h2
          class="text-5xl font-bold mb-8 leading-tight text-white text-center"
        >
          Your information has been sent successfully!
        </h2>

        <p class="text-lg mb-12 text-gray-100 max-w-2xl text-center">
          * The account will be verified by our team within 24 hours. An email
          will be sent to you when it is done so you can start filling out your
          ESG information.
        </p>
      ...
      <div v-else class="w-full max-w-xl">
        ...
        <div v-if="currentStep === 0" class="space-y-8">
          ...
          <form @submit.prevent="nextStep" class="space-y-6">
            ...
            <v-checkbox v-model="agreedToTerms" density="comfortable">
              <template #label>
                <span class="text-xs">
        ...
        <div v-if="currentStep === 1" class="space-y-6">
          <header class="mb-12">
            <span
              class="text-sm font-bold uppercase tracking-widest text-blue-600 mb-2 block"
              >2nd Step</span
            >
            <h2 class="text-4xl font-bold tracking-tight text-gray-900">
              ID card and video chat
            </h2>
          </header>
          ...
          <div>
            ...
            <!-- Image Previews -->
            <div
              v-if="idCardFrontPreview || idCardBackPreview"
          ...
          <div>
            <p class="font-semibold mb-4">
              Start your video chat to verify your identity
            </p>
            <div
          ...
          <div class="flex gap-4 justify-between mt-12">
            ...
            <AppButton @click="nextStep" color="primary"> Next </AppButton>
          </div>
        </div>
        ...
        <div v-if="currentStep === 2" class="space-y-6">
          ...
          <div class="flex gap-4 justify-between mt-12">
            ...
            <AppButton @click="submit" color="primary" :loading="isLoading">
              Sign Up
            </AppButton>
          </div>
        </div>
...
const steps = [
  "Personal information",
  "ID card and video chat",
  "Documents of your title to the firm",
];
