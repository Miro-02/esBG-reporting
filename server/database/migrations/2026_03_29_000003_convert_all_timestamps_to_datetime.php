...
return new class extends Migration
{
    ...
    {
        // For PostgreSQL, foreign key constraints are handled differently
        // No need to disable them at the connection level
        
        $connection = DB::getDefaultConnection();
        
        // Only run timestamp conversion for MySQL
        // PostgreSQL already handles timestamps correctly
        if ($connection === 'mysql') {
            ...
            $tables = [
                ...
                'personal_access_tokens' => ['created_at', 'updated_at'],
            ];
